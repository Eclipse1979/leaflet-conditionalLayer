...
* `DisplaySort:` sort function which is passed each layer.  default sort is by each layers leaflet_ID, but the function can use any value stored in each layer to sort them.
